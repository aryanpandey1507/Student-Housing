...
const Flat = require('../models/productModels'); 
...
exports.createProductReview = catchAsyncErrors(async (req,res,next)=>{
    ...
    const product = await Flat.findById(productId);
...
exports.getProductReviews= catchAsyncErrors(async (req,res,next)=>{
    ...
    const product = await Flat.findById(req.query.id);
...
exports.DeleteReviews= catchAsyncErrors(async (req,res,next)=>{
    ...
    const product = await Flat.findById(req.query.productId);
    ...
    await Flat.findByIdAndUpdate(req.query.productId,{
        reviews,
        ratings,
        numofReviews
    },{
